...
The server must be configured for OAuth as described in the [Vertica documentation](https://www.vertica.com/docs/12.0.x/HTML/Content/Authoring/Security/ClientAuth/OAuth/ConfiguringOAuth.htm).
